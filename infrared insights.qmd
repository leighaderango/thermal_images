...
def bulk_contours(img_list):
  ...
  for image in img_list:
    ...
    if len(approx_contour) > 4:
      ...
      inner_temp = (inner_gray/255)*scale_diff + scale_lower_numeric
      outer_temp = (outer_gray/255)*scale_diff + scale_lower_numeric
      # temp = prop/255*scale range + lower end of scale
